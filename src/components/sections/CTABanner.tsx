        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-sm sm:text-base mb-8 leading-relaxed" style={{ color: "var(--color-text-secondary)" }}>
              Get in touch with our engineering team in Chh. Sambhaji Nagar (Aurangabad) for a free site evaluation, BOQ calculation, and quotation across Maharashtra & India.
            </p>
