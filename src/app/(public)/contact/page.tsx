        ...
        <div className="container max-w-6xl">
          <div>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 pb-3 border-b border-slate-200/80">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  MIDC Industrial Area, Mukundwadi, Chh. Sambhaji Nagar, Maharashtra 431006, India
                </p>
              </div>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="btn btn-outline btn-sm rounded-xl text-xs font-bold gap-1.5 self-start sm:self-auto"
              >
            ...
            <div className="rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-200/80 shadow-xs">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3752.176045974052!2d75.3789!3d19.8741!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdba3867256c413%3A0xb815fca3e276a098!2sOcean%20MGPS%20sales%20and%20Multy%20Services!5e0!3m2!1sen!2sin!4v1700000000000"
                width="100%"
                height="380"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Ocean MGPS Sales & Multi Services — MIDC Industrial Area, Mukundwadi, Chh. Sambhaji Nagar"
              />
            </div>
          </div>
        </div>
