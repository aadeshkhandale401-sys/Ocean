...
export const metadata: Metadata = {
  title: "Project Showcase — MGPS Installations & Modular OT Setups | Sambhaji Nagar & Jalna",
  description:
    "View Ocean MGPS completed projects: turnkey MGPS installations, modular operation theater setups, oxygen manifold systems, and LPG copper pipeline networks in Chh. Sambhaji Nagar, Jalna, Maharashtra, and across India.",
  keywords: [
    ...
    "Jalna Hospital Pipeline Projects",
  ...
  openGraph: {
    title: "Project Showcase — MGPS Installations & Modular OT Setups | Sambhaji Nagar & Jalna",
    description:
      "Explore 150+ completed medical gas pipeline installations, modular OTs, and hospital equipment projects in Chh. Sambhaji Nagar, Jalna, Maharashtra & across India.",
