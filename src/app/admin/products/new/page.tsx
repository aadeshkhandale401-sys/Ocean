...
export default function NewProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      await addDocument("products", { ...form, images, order: 0 });
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-xs">
            ...
            <label className="flex flex-col items-center gap-2 p-6 rounded-xl border-2 border-dashed border-slate-200 cursor-pointer transition-colors hover:border-blue-500 hover:bg-blue-50/30">
